...
import 'package:snapchat_clone/snapchat_bottomnavbar_option2/Widgets/ChatItemWidgets/chatItem_Widget.dart';
import 'package:snapchat_clone/snapchat_bottomnavbar_option2/startNewChat_Screen.dart';
import 'package:snapchat_clone/snapchat_bottomnavbar_option2/userDetails_Screen.dart';
      ...
      body: Stack(
        children: [
          ...
          ListView(
            ...
            children: <Widget>[
              chatItem(context, "Faizan Qazi", true, "1d", true),
              Divider(
                thickness: 0.3,
                color: Colors.grey,
              ),
              chatItem(context, "Fozan Shahid", false, "24h", true),
              ...
              Divider(thickness: 0.3, color: Colors.grey),
              chatItem(context, "Rao Obaid", false, "5h", false),
              Divider(thickness: 0.3, color: Colors.grey),
              chatItem(context, "Faizan Qazi", true, "1d", true),
              Divider(thickness: 0.3, color: Colors.grey),
              chatItem(context, "Fozan Shahid", false, "24h", true),
